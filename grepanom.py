...
import ntiris as nt
"""
Regressions between surface temp of local regions, e.g. Aus, Indian, and global variables, i.e. wind
...
#     TropSthAm_reg = nt.linregts(cube,TropSthAm_mean,name1,name2)
#     print "Calc reg/cor for SthSthAm"
#     SthSthAm, SthSthAm_mean = regmean(land_cube,loni=270,lonf=315,lati=-60,latf=-24)
#     name1 = 'SthSthAm tsfc'
#     SthSthAm_reg = nt.linregts(cube,SthSthAm_mean,name1,name2)
...
#     NthWestAfr_reg = nt.linregts(cube,NthWestAfr_mean,name1,name2)
...
#     NthEastAfr_reg = nt.linregts(cube,NthEastAfr_mean,name1,name2)
#     print "Calc reg/cor for TropAfr"
#     TropAfr, TropAfr_mean = regmean(land_cube,loni=12,lonf=40,lati=-15,latf=5)
#     name1 = 'TropAfr tsfc'
#     TropAfr_reg = nt.linregts(cube,TropAfr_mean,name1,name2)
#     print "Calc reg/cor for SthAfr"
#     SthAfr, SthAfr_mean = regmean(land_cube,loni=12,lonf=40,lati=-35,latf=-15)
#     name1 = 'SthAfr tsfc'
#     SthAfr_reg = nt.linregts(cube,SthAfr_mean,name1,name2)
    print "Calc reg/cor for Aus"
    Aus, Aus_mean = regmean(land_cube,loni=110,lonf=160,lati=-45,latf=-7)
    name1 = 'Aus tsfc'
    Aus_reg = nt.linregts(cube,Aus_mean,name1,name2)


    return [Aus_reg] #[India_reg, MC_reg, TropSthAm_reg , SthSthAm_reg , NthWestAfr_reg , NthEastAfr_reg, TropAfr_reg, SthAfr_reg, Aus_reg]
...
# v = iris.load_cube(ncfile_path + 'v.thlev.4ysl.regrid.nc')
# w = iris.load_cube(ncfile_path + 'w.thlev.4ysl.regrid.nc')
# print 'regridding v'
