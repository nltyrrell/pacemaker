...
w_thlev = iris.load_cube(ncfile_path + 'w.thlev.4ysl.nc')
u_thlev = iris.load_cube(ncfile_path + 'u.thlev.4ysl.nc')
v_thlev = iris.load_cube(ncfile_path + 'v.thlev.4ysl.nc')

u_thlev.coord('Hybrid height').standard_name = 'atmosphere_hybrid_height_coordinate'
v_thlev.coord('Hybrid height').standard_name = 'atmosphere_hybrid_height_coordinate'

w_thlev.coords()[0].standard_name = 'time'
u_thlev.coords()[0].standard_name = 'time'
v_thlev.coords()[0].standard_name = 'time'
new_w = u_thlev.copy()
new_w.data = w_thlev.data
new_w.standard_name = w_thlev.standard_name

iris.save(u_thlev,ncfile_path+'u.thlev.4ysl.fix.nc')
iris.save(v_thlev,ncfile_path+'v.thlev.4ysl.fix.nc')
iris.save(new_w,ncfile_path+'w.thlev.4ysl.fix.nc')
